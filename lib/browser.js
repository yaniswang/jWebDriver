...
Browser.prototype = {
	...
	switchTo: function(target){
		...
		if(typeof target === 'string'){
			...
			self.doCommand('switchFrame',{id: target.toJson()});
		}
	 ...
	 * @return {Element}       Element的实例对象，如果对象不存在，返回false
	 */
	element: function(using, value){
		var element = new Element(this, using, value);
		return element._id === undefined ? false : element;
	}
