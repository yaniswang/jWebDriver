            ...
            if(png64){
                if(self.browserMode && elem){
                    ...
                    if(elems.length === 1){
                        ...
                        gmShot.crop(rect.width * devicePixelRatio, rect.height * devicePixelRatio, rect.left * devicePixelRatio, rect.top * devicePixelRatio);
