...
let mapCommands = {
	...
	'getHtml' : ['GET', '/session/:sessionId/source'],

	'eval' : ['POST', '/session/:sessionId/execute'],
	'evalASync' : ['POST', '/session/:sessionId/execute_async'],
	...
	'getElementAttr': ['GET', '/session/:sessionId/element/:id/attribute/:name'],
